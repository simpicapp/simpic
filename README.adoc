...
Simpic is licensed under the MIT licence. A full copy of the licence is available in
the link:LICENCE.adoc[LICENCE.adoc] file.

Simpic makes use of a number of third-party libraries. See the link:go.mod[go.mod] file
