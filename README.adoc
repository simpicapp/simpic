...
| true
| Whether to attempt to create a new key to sign authentication tokens if one doesn't exist.

| SIMPIC_AUTH_KEY_FILE
| data/auth.key
| Path to the X509-marshalled ES256 key to use to sign authentication tokens.
